  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column prop="date" label="创建时间" align="center" width="300" sortable>
        ...
        <el-table-column prop="describe" label="收支描述" align="center" width="220"></el-table-column>
        ...
        <el-table-column prop="remark" label="备注" align="center" width="user.identity =='manager' ? 250 : 300"></el-table-column>
        <el-table-column prop="operation" align="center" label="操作" v-if="user.identity =='manager'">
          <template slot-scope="scope">
            <el-button
              type="warning"
              icon="edit"
